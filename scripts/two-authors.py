...
# ---------- match author_1_institution to dictionary ror_name and fill old names ----------
author1_lookup = (
    df[["author1_affi_raw", "author_1_institution"]]
    .dropna(subset=["author1_affi_raw", "author_1_institution"])
    .drop_duplicates()
)
...
dictionary = dictionary.merge(
    author1_lookup,
    left_on="ror_name",
    right_on="author_1_institution",
    how="left"
)

dictionary["old names"] = dictionary["author1_affi_raw"].combine_first(dictionary["old names"])

dictionary = dictionary.drop(columns=["author1_affi_raw", "author_1_institution"])
