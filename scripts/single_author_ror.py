...
tqdm.pandas(desc="Matching single-author affiliations")
...
# 跑匹配
match_results = df_single["affiliations"].progress_apply(ror_match_debug)
...
# 保存
output_path = "/Users/yutingren/Library/CloudStorage/Dropbox/Mac/Documents/AI/test_nov/abstract_analysis-main/outputs/db_info_abstract_single_author_ror.csv"
...
print("Saved short sample to:", short_output_path)
